...
export default function Skills() {
  return (
    <section id="skills" className="py-20 bg-white section-animate">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        {/* Header */}
        <div className="text-center mb-12">
          <p className="text-xs text-purple-500 font-medium tracking-widest uppercase mb-2">✦ Skills</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">My technical toolkit</h2>
          <p className="text-gray-400 text-sm">Technologies and tools I use to turn ideas into production.</p>
        </div>

        {/* Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {skillCategories.map((cat) => (
            <div key={cat.title} className="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow">
