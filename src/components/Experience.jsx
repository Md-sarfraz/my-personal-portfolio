export default function Experience() {
  return (
    <section id="experience" className="py-20 bg-white section-animate">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        {/* Header */}
        <div className="text-center mb-12">
          <p className="text-xs text-purple-500 font-medium tracking-widest uppercase mb-2">✦ Experience</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">Where I've worked</h2>
        </div>

        {/* Timeline */}
        <div className="relative max-w-2xl mx-auto">
          {/* Line */}
          <div className="absolute left-4 top-0 bottom-0 w-px bg-purple-100"></div>

          <div className="pl-12 relative">
            {/* Dot */}
            <div className="absolute left-[13px] top-1 w-3 h-3 rounded-full bg-purple-500 border-2 border-white shadow"></div>

            <div className="bg-gray-50 rounded-xl p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-1">
                <h3 className="font-bold text-gray-900 text-sm">Software Developer Intern</h3>
                <span className="text-xs text-gray-400 mt-1 sm:mt-0">June 2025 → Nov 2025</span>
              </div>
